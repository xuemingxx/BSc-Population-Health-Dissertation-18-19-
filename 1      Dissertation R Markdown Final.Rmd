...
```{r}
##########################      Data Preparation  --  Convert the inapplicable cases to NAs      ##############################
...
hse.mk20$sys1om <- ifelse(hse.mk20$sys1om < 0 | hse.mk20$sys1om > 200, NA, hse.mk20$sys1om)
hse.mk20$sys2om <- ifelse(hse.mk20$sys2om < 0 | hse.mk20$sys2om > 200, NA, hse.mk20$sys2om)
hse.mk20$sys3om <- ifelse(hse.mk20$sys3om < 0 | hse.mk20$sys3om > 200, NA, hse.mk20$sys3om)
hse.mk20$dias1om <- ifelse(hse.mk20$dias1om < 0 | hse.mk20$dias1om > 200, NA, hse.mk20$dias1om)
hse.mk20$dias2om <- ifelse(hse.mk20$dias2om < 0 | hse.mk20$dias2om > 200, NA, hse.mk20$dias2om)
...
hse.mk50.mi <- aregImpute(~ hyper + sex + tenureb + origin + hhsize + addnum + imd + birthwt + 
                            porftvg + gor + aggr + year + sysavg + diaavg, data = hse.mk50, n.impute = 5, nk=0)
