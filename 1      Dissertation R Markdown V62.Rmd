...
hse.mk90.bn <- hse.mk90[c(hse.mk90$hyper == 0),]
...
hse.mk90.by <- hse.mk90[c(hse.mk90$hyper == 1),]
myVars <- c("sex", "tenureb", "origin", "hhsize", "birthwt", "porftvg","gor", "aggr", "year")
catVars <- c("sex", "tenureb", "origin", "hhsize", "porftvg","gor", "aggr", "year")
...
hse.mk.FX.an <- hse.mk.FX[c(hse.mk.FX$hyper == 0),]
myVars <- c("sex", "tenureb", "origin", "hhsize", "birthwt", "porftvg","gor", "aggr", "year")
catVars <- c("sex", "tenureb", "origin", "hhsize", "porftvg","gor", "aggr", "year")
tab3 <- CreateTableOne(vars = myVars, data = hse.mk.FX, factorVars = catVars)
tab3

hse.mk.FX.ay <- hse.mk.FX[c(hse.mk.FX$hyper == 1),]
myVars <- c("sex", "tenureb", "origin", "hhsize", "birthwt", "porftvg","gor", "aggr", "year")
catVars <- c("sex", "tenureb", "origin", "hhsize", "porftvg","gor", "aggr", "year")
tab4 <- CreateTableOne(vars = myVars, data = hse.mk.FX, factorVars = catVars)
tab4
```
