...
##############
#             Part 2/5: Current Hypertension Phenomenon Plotting
##############
...
##############
#             Part 3/5: Principal Components Analysis (PCA) & Correspondence analysis (CORA) 
##############
...
##############
#             Part 4/5: The Effect of Deprivation  --  Propensity Analysis
##############
...
#            but still significant in explaining hypertension disparities between areas with different deprivation value.

```

##############
#             Part 5/5: Propensity Analysis -- Sensitivity Test
##############
...
set.seed(99)
matching.vars <- cbind(hse.mk90$fit.value)
psm <- Match(Y=hse.mk90$hyper, Tr=hse.mk90$imd, X=matching.vars, Weight = 2, ties = T, version = "fast")
summary.Match(psm)
#    1  --   Estimate effect of deprivation on hypertention (significant) 
# Balance test
MatchBalance(imd ~ sex + tenureb + origin + hhsize + addnum + birthwt + porftvg + gor + aggr + year, 
